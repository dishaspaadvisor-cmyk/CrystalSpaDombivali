...
export default function ServicesHero() {
  ...
  return (
    <section className="relative overflow-hidden">
      <div className="relative min-h-[550px] sm:min-h-[600px] lg:h-[80vh]">
        {/* Background */}
        <Image
          src="/hero/hero2.png"
          alt="Crystal Spa Services"
          fill
          priority
          ...
          <div className="container mx-auto px-4 sm:px-6 lg:px-12">
            <div className="max-w-3xl text-center lg:text-left text-white">
              ...
              <p className="mt-6 max-w-2xl text-base leading-7 text-gray-200 sm:text-lg sm:leading-8 md:text-xl lg:max-w-xl">
                Experience luxury massage therapies, rejuvenating wellness
                treatments, and complete relaxation designed to refresh
